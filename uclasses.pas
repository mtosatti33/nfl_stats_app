...
type
  ...
  private
    procedure SetVisibleByStat(qry: TZQuery; grid: TDBGrid; ColCount: integer);
    procedure SetColumnsProperties(frm: TForm; qry: TZQuery;
...
procedure TGridTools.SetVisibleByStat(qry: TZQuery; grid: TDBGrid; ColCount: integer);
var
  i: integer;
begin
  ...
  //Defense
  if (qry.FieldByName('Comb').Value > 0) or (qry.FieldByName('Scks').Value > 0) or
